...
$RecipeInfo['SectionEdit']['Version'] = '2013-02-06 - v2.2.3';
...
# for PHP 5.4, copied from pmwiki.php
if(! function_exists('PHSC')) {
  function PHSC($x, $flags=ENT_COMPAT, $enc=null) { 
...
Markup_e('nosections', 'directives', '/\\(:nosections:\\)/i', "PZZ(\$GLOBALS['SectionEditDisable'] = true)");
Markup_e('autosections', '>nosections', '/\\(:autosections\s*(\d)*:\\)/i', "PZZ(\$GLOBALS['SectionEditWithoutHeaders'] = false)");
Markup_e('noautosections', '>autosections', '/\\(:noautosections\s*(\d)*:\\)/i', "PZZ(\$GLOBALS['SectionEditWithoutHeaders'] = true)");
Markup_e('nosectionsinincludes','directives','/\\(:nosectionsinincludes:\\)/i', "PZZ(\$GLOBALS['SectionEditInIncludes'] = false)");
Markup_e('horzsections', '>nosections', '/\\(:horzsections\s*(\d)*:\\)/i', "PZZ(\$GLOBALS['SectionEditHorzLines'] = true)");
Markup_e('nohorzsections', '>horzsections', '/\\(:nohorzsections\s*(\d)*:\\)/i', "PZZ(\$GLOBALS['SectionEditHorzLines'] = false)");
...
Markup_e('sectionedit','links',
  ...
  "SectionEditCreateLink(\$m[1],\$m[2],\$m[3],\$m[4], PSS(\$m[5]))");
#                        $1          $2          $3          $4          $5
...
function SectionEditCreateLink($pagename, $type, $number, $from='', $title) {
        ...
        $editlink = FmtPageName("<a name='s$pagename".'_'."$number'></a><a href='\$PageUrl?action=edit&amp;s=".
                $number."&amp;auto=".
                ($SectionEditWithoutHeaders ? "n" : "y")."&amp;from=$from' title='".$title."'>$[(Edit)]</a>", $pagename);
#eMFix
